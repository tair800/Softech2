    ...
    public class BlogService : IBlogService
    {
        ...
        public async Task<BlogResponseDto> CreateAsync(CreateBlogDto createDto)
        {
            var blog = new Blog
            {
                ...
                Desc3 = createDto.Desc3,
                Title3En = createDto.Title3En,
                Title3Ru = createDto.Title3Ru,
                Desc3En = createDto.Desc3En,
                Desc3Ru = createDto.Desc3Ru,
        ...
        public async Task<BlogResponseDto?> UpdateAsync(int id, UpdateBlogDto updateDto)
        {
            ...
            blog.Title3 = updateDto.Title3;
            blog.Desc3 = updateDto.Desc3;
            blog.Title3En = updateDto.Title3En;
            blog.Title3Ru = updateDto.Title3Ru;
            blog.Desc3En = updateDto.Desc3En;
            blog.Desc3Ru = updateDto.Desc3Ru;
        ...
        private static BlogResponseDto MapToResponseDto(Blog blog)
        {
            return new BlogResponseDto
            {
                ...
                Title3 = blog.Title3,
                Desc3 = blog.Desc3,
                Title3En = blog.Title3En,
                Title3Ru = blog.Title3Ru,
                Desc3En = blog.Desc3En,
                Desc3Ru = blog.Desc3Ru,
